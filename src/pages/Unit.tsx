...
const useSetupWizard = ({ projectState, taskState, riskState, kraState, assetState }) => {
  ...
  const renderSetupWizardContent = useCallback(() => {
    switch (setupStep) {
      case 1:
        return (
          <div className="space-y-4 py-2">
            <h3 className="text-lg font-medium">Step 1: Unit Information</h3>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="unitName">Unit Name</Label>
                  <Input id="unitName" placeholder="Enter unit name" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="unitHead">Unit Head</Label>
                  <Input id="unitHead" placeholder="Name of unit head" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="unitDescription">Description</Label>
                  <Textarea id="unitDescription" placeholder="Brief description of the unit" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="unitDepartment">Department</Label>
                  <Select>
                    <SelectTrigger>
      ...
      case 2:
        return (
          <div className="space-y-4 py-2">
            <h3 className="text-lg font-medium">Step 2: Team Members</h3>
            <div className="space-y-4">
      ...
      case 3:
        return (
          <div className="space-y-4 py-2">
            <h3 className="text-lg font-medium">Step 3: Key Result Areas</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label>KRAs</Label>
                <Button variant="outline" size="sm" className="h-8">
              ...
              {kraState.kras.length === 0 ? (
                <div className="rounded-md border border-dashed p-8 text-center">
                  <h4 className="mb-2 text-sm font-medium">No KRAs configured</h4>
                  <p className="text-sm text-muted-foreground mb-4">
                    Add key result areas to track your unit's performance
                  </p>
                ...
                <Table>
                  ...
                  <TableBody>
                    {kraState.kras.map(kra => (
                      <TableRow key={kra.id}>
                        <TableCell>{kra.name}</TableCell>
                        <TableCell>{kra.objectiveName}</TableCell>
                        <TableCell>
                          <div className="flex items-center gap-2">
                            <Progress value={kra.progress} className="h-2 w-[100px]" />
                            <span className="text-xs">{kra.progress}%</span>
                          </div>
                        </TableCell>
                        <TableCell>
                          <Button variant="ghost" size="icon">
      ...
      case 4:
        return (
          <div className="space-y-4 py-2">
            <h3 className="text-lg font-medium">Step 4: Dashboard Preferences</h3>
            <div className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="showProjects" defaultChecked />
                    <label htmlFor="showProjects" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                      Projects
                    </label>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="showRisks" defaultChecked />
                    <label htmlFor="showRisks" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                      Risks
                    </label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="showKRAs" defaultChecked />
                    <label htmlFor="showKRAs" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                      KRAs
                    </label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="showAssets" defaultChecked />
                    <label htmlFor="showAssets" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                      Assets
                    </label>
                  </div>
                </div>
  ...
  return (
    <PageLayout>
      <div className="p-6 flex">
        ...
        {/* Setup Wizard Dialog (conditionally rendered) */}
        {setupState.showSetupWizard && (
          <Dialog open={setupState.showSetupWizard} onOpenChange={setupState.setShowSetupWizard}>
            <DialogContent className="max-w-3xl">
              <DialogHeader>
                <DialogTitle>Unit Setup Wizard</DialogTitle>
                <DialogDescription>
                  Configure your unit with key information to get started.
                </DialogDescription>
              </DialogHeader>
              
              {/* Dialog content for setup wizard steps - handled by useSetupWizard hook */}
              {setupState.renderSetupWizardContent()}
              
              <DialogFooter>
                <div className="flex justify-between w-full">
                  <Button 
                    variant="outline" 
                    onClick={setupState.handlePrevStep}
                    disabled={setupState.setupStep === 1}
                  >
                    Previous
                  </Button>
                  <Button onClick={setupState.handleNextStep}>
                    {setupState.setupStep < 4 ? 'Next' : 'Finish Setup'}
                  </Button>
                </div>
              </DialogFooter>
            </DialogContent>
